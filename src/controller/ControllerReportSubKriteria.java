 ...
 * @author ndull
 */
public class ControllerReportSubKriteria {
    ViewMain frm;
    ...
    public ControllerReportSubKriteria(ViewMain frm) {
        this.frm = frm;
    ...
    public void ShowReport() throws SQLException{
        try {
            try {
                ...
                Logger.getLogger(ControllerReportSubKriteria.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            nama_file = "src/report/ReportSubKriteria.jrxml";
