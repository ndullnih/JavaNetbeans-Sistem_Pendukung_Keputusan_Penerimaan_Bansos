 ...
 * @author ndull
 */
public class ControllerReportAnggota {
    ViewMain frm;
    ...
    public ControllerReportAnggota(ViewMain frm) {
        this.frm = frm;
    ...
    public void ShowReport() throws SQLException{
        try {
            try {
                ...
                Logger.getLogger(ControllerReportAnggota.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            nama_file = "src/report/ReportAnggota.jrxml";
